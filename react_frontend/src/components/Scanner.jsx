        ...
        <div className="border-b border-slate-800 bg-[radial-gradient(circle_at_top,_rgba(45,212,255,0.12),_transparent_38%)] px-6 py-10 sm:px-10">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full border border-cyan-400/20 bg-cyan-400/10 px-5 py-3 text-sm font-semibold text-cyan-200 transition hover:border-cyan-300/40 hover:bg-cyan-400/15 disabled:opacity-50"
            >
              View Analytics
            </button>
          </div>
          ...
          <div className="mt-8 flex flex-col gap-3 rounded-3xl border border-slate-800 bg-slate-950/80 p-3 sm:flex-row">
            ...
            <button
              onClick={startScan}
              disabled={loading}
              className="rounded-2xl bg-cyan-400 px-6 py-4 text-sm font-bold tracking-[0.18em] text-slate-950 uppercase transition hover:bg-cyan-300 disabled:opacity-60"
            >
        ...
        {data && (
          <section className="px-6 py-8 sm:px-10">
            ...
            <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
              ...
              {/* AI SUMMARY BOX (EXACT REPO STYLE) */}
              <div className="rounded-3xl border border-cyan-400/20 bg-slate-900/60 backdrop-blur-xl p-8 shadow-[0_0_40px_rgba(45,212,255,0.12)] h-96 flex flex-col">
                ...
                <button
                  ...
                  className="mt-6 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:scale-105 hover:shadow-cyan-400/30"
                >
                  Download Report
                </button>
              </div>
